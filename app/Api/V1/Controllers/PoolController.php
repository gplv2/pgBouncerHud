...
class PoolController extends Controller
{
    ...
    public function databases(Request $request, $buid=null)
    {
        $currentUser = JWTAuth::parseToken()->authenticate();
        ...
        if (!empty($buid)){
            // $bouncers = Bouncer::where('id','=',$buid);
            // $bouncers = Bouncer::all();
        ...
        // postgresql://bouncer-date:bouncer-secret@127.0.0.1:5432/pgbouncer
        //var_dump($bouncers);exit;
        $resultsset = array();
        //$bcr = $bouncers->each(function ($bouncer, $id) {
        //
    ...
    public function stats(Request $request, $buid)
    {
        $currentUser = JWTAuth::parseToken()->authenticate();
