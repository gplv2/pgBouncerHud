...
*/
        $bball = array(
            ...
            array("label"=>"bouncer-arts", "category_id"=>0 ,"dsn"=>"postgresql://pghud:OVBx0iyJIM6qE@192.168.16.7:5432/pgbouncer","priority"=>0 ,"tag"=> "prd","description"=>"Arts bouncer", "enabled"=>true),
            ...
            array("label"=>"bouncer-smu", "category_id"=>0 ,"dsn"=>"postgresql://pghud:OVBx0iyJIM6qE@192.168.16.8:5432/pgbouncer","priority"=>0 ,"tag"=> "prd","description"=>"SMU prd", "enabled"=>true),
            array("label"=>"bouncer-ppc-smu", "category_id"=>0 ,"dsn"=>"postgresql://pghud:OVBx0iyJIM6qE@192.168.14.232:5432/pgbouncer","priority"=>0 ,"tag"=> "prd","description"=>"PPC SMU prd", "enabled"=>true),
            ...
            array("label"=>"bouncer-ppc-arts-sta", "category_id"=>0 ,"dsn"=>"postgresql://pghud:OVBx0iyJIM6qE@192.168.13.207:5432/pgbouncer","priority"=>0 , "tag"=> "tst","description"=>"PPC arts tst", "enabled"=>true),
            ...
            array("label"=>"bouncer-smu-sta", "category_id"=>0 ,"dsn"=>"postgresql://pghud:OVBx0iyJIM6qE@192.168.23.58:5432/pgbouncer","priority"=>99 ,"tag"=> "sta","description"=>"SMU sta", "enabled"=>true),
            array("label"=>"bouncer-arts-sta", "category_id"=>0 ,"dsn"=>"postgresql://pghud:OVBx0iyJIM6qE@192.168.23.55:5432/pgbouncer","priority"=>99 ,"tag"=> "sta","description"=>"ARTS sta", "enabled"=>true),
            ...
            array("label"=>"bouncer-arts-dev", "category_id"=>0 ,"dsn"=>"postgresql://pghud:OVBx0iyJIM6qE@192.168.26.157:5432/pgbouncer","priority"=>0 ,"tag"=> "dev","description"=>"Arts test", "enabled"=>true),
            array("label"=>"bouncer-arts-dev", "category_id"=>0 ,"dsn"=>"postgresql://pghud:OVBx0iyJIM6qE@192.168.26.158:5432/pgbouncer","priority"=>0 ,"tag"=> "dev","description"=>"Siamu test", "enabled"=>true),
