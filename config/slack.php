...
return [
    ...
    */
    ...
    'endpoint' => env('SLACK_ENDPOINT', 'https://hooks.slack.com/services/<your_hook>'),
    ...
    */
    ...
    'channel' => env('SLACK_CHANNEL', '@gplv2'),
    ...
    */
    ...
    // 'markdown_in_attachments' => ['text', 'title', 'description'],
